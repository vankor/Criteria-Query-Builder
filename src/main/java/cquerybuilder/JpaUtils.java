...
public abstract class JpaUtils {
     ...
     * @return row count
     */
    public static <T> List<Long> count(EntityManager em, CriteriaQuery<T> criteria) {
        return em.createQuery(countCriteria(em, criteria)).getResultList();
    }
...
// reset alias count
    ...
    public static void setExplicitJoins(CriteriaQuery<?> from, CriteriaQuery<?> to){
